...
namespace Mediatr.Extensions.Microsoft.AspNetCore.Mvc
{
    public static class MvcOptionsExtensions
    {
        ...
        public static void AddMediatrMvcConvention(this MvcOptions options) => AddMediatrMvcConvention(options, null, null);
        ...
        public static void AddMediatrMvcConvention(this MvcOptions options, Func<Type, string> provideControllerName) => AddMediatrMvcConvention(options, provideControllerName, null);
        ...
        public static void AddMediatrMvcConvention(this MvcOptions options, Func<Type, RequestType> classifyRequestType) => AddMediatrMvcConvention(options, null, classifyRequestType);
